...
- Name: backend\tests\api-regression.spec.ts >> Iris Sciences - Backend (API) Regression Suite >> JTC-009 - Junior Coordinator should NOT be allowed to update subject records via PATCH
- Location: backend\tests\api-regression.spec.ts:20:7
