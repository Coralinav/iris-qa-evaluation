...
- Name: backend\tests\api-regression.spec.ts >> Iris Sciences - Backend (API) Regression Suite >> TS-003 & JTC-003 - Subject search by official ID format "S-XXXX" should return the subject
- Location: backend\tests\api-regression.spec.ts:7:7
