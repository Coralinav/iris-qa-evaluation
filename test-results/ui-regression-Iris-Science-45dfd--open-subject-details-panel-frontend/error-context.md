...
- Name: frontend\tests\ui-regression.spec.ts >> Iris Sciences - Frontend (UI) Regression Suite >> TS-002 - Test Subject can open subject details panel
- Location: frontend\tests\ui-regression.spec.ts:44:7
