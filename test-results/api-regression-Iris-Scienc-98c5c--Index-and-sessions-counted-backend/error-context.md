...
- Name: backend\tests\api-regression.spec.ts >> Iris Sciences - Backend (API) Regression Suite >> DIR-005 - Dashboard API should return non-zero QE Index and sessions counted
- Location: backend\tests\api-regression.spec.ts:94:7
