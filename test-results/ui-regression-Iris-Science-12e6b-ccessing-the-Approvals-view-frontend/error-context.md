...
- Name: frontend\tests\ui-regression.spec.ts >> Iris Sciences - Frontend (UI) Regression Suite >> TS-006 - Test Subject should be restricted from accessing the Approvals view
- Location: frontend\tests\ui-regression.spec.ts:59:7
...
Expected pattern: not /.*\/admin\/approvals/
Received string: "https://iris.revelarautomation.com/admin/approvals"
Timeout: 5000ms

Call log:
  - Expect "not toHaveURL" with timeout 5000ms
    14 × unexpected value "https://iris.revelarautomation.com/admin/approvals"
