...
- Name: backend\tests\api-regression.spec.ts >> Iris Sciences - Backend (API) Regression Suite >> TS-012 - Test Subject should NOT be allowed to list all subjects
- Location: backend\tests\api-regression.spec.ts:52:7
