...
- Name: frontend\tests\ui-regression.spec.ts >> Iris Sciences - Frontend (UI) Regression Suite >> JTC-002 - Junior Coordinator can open subject details panel
- Location: frontend\tests\ui-regression.spec.ts:74:7
...
Locator:  locator('text=Select a subject for detail.')
...
Call log:
  ...
  - waiting for locator('text=Select a subject for detail.')
    14 × locator resolved to <div class="bg-modern-surface border border-modern-line rounded-2xl shadow-xs p-6 text-modern-ink-3">Select a subject for detail.</div>
       - unexpected value "visible"

```

```yaml
- text: Select a subject for detail.
```
