...
- Name: backend\tests\api-regression.spec.ts >> Iris Sciences - Backend (API) Regression Suite >> TS-016 - Test Subject should NOT be allowed to view apparatus list
- Location: backend\tests\api-regression.spec.ts:76:7
