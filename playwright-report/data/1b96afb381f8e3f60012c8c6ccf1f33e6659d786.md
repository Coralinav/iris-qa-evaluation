...
- Name: backend\tests\api-regression.spec.ts >> Iris Sciences - Backend (API) Regression Suite >> JTC-010 - Junior Coordinator should NOT be allowed to export reports
- Location: backend\tests\api-regression.spec.ts:33:7
