...
- Name: frontend\tests\ui-regression.spec.ts >> Iris Sciences - Frontend (UI) Regression Suite >> PS-001 & PS-002 - Public Site navigation links should not return 404
- Location: frontend\tests\ui-regression.spec.ts:17:7
...
Call log:
  ...
  - waiting for locator('text=Not Found')
    14 × locator resolved to <h3>404 Not Found</h3>
