...
- Name: backend\tests\api-regression.spec.ts >> Iris Sciences - Backend (API) Regression Suite >> TS-015 - Test Subject should NOT be allowed to view chambers list
- Location: backend\tests\api-regression.spec.ts:70:7
