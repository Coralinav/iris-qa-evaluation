...
- Name: frontend\tests\ui-regression.spec.ts >> Iris Sciences - Frontend (UI) Regression Suite >> JTC-001 - Junior Coordinator Dashboard should not display Approve/Reject buttons
- Location: frontend\tests\ui-regression.spec.ts:66:7
